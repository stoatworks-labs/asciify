...
`asctest --presets` drives all three hosts across every preset, with no GL
...
A preset covers type and colour. The Custom Set string belongs to the
operator, and Mix is the wet/dry — neither is part of any look.
