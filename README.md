...
**[v1.0.6](https://github.com/stoatworks-labs/asciify/releases/tag/v1.0.6)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`asciify-1.0.6-macos-universal.dmg`](https://github.com/stoatworks-labs/asciify/releases/download/v1.0.6/asciify-1.0.6-macos-universal.dmg) | 231 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`asciify-1.0.6-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/asciify/releases/download/v1.0.6/asciify-1.0.6-windows-x86_64-setup.exe) | 225 KB |
