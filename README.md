...
**[v1.0.2](https://github.com/stoatworks-labs/asciify/releases/tag/v1.0.2)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`asciify-1.0.2-macos-universal.dmg`](https://github.com/stoatworks-labs/asciify/releases/download/v1.0.2/asciify-1.0.2-macos-universal.dmg) | 237 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`asciify-macos-universal.zip`](https://github.com/stoatworks-labs/asciify/releases/latest/download/asciify-macos-universal.zip) | 188 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`asciify-1.0.2-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/asciify/releases/download/v1.0.2/asciify-1.0.2-windows-x86_64-setup.exe) | 224 KB |
| x64 · .zip archive | [`asciify-windows-x86_64.zip`](https://github.com/stoatworks-labs/asciify/releases/latest/download/asciify-windows-x86_64.zip) | 117 KB |
