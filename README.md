...
**[v1.0.5](https://github.com/stoatworks-labs/asciify/releases/tag/v1.0.5)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`asciify-1.0.5-macos-universal.dmg`](https://github.com/stoatworks-labs/asciify/releases/download/v1.0.5/asciify-1.0.5-macos-universal.dmg) | 231 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`asciify-macos-universal.zip`](https://github.com/stoatworks-labs/asciify/releases/latest/download/asciify-macos-universal.zip) | 191 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`asciify-1.0.5-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/asciify/releases/download/v1.0.5/asciify-1.0.5-windows-x86_64-setup.exe) | 225 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .zip archive (OpenFX — Resolve, Vegas, Nuke) | [`asciify-ofx-linux-x86_64.zip`](https://github.com/stoatworks-labs/asciify/releases/latest/download/asciify-ofx-linux-x86_64.zip) | 717 KB |
